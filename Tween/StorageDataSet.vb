...
Namespace StorageDataSetTableAdapters
    Partial Class PostsTableAdapter
        Public Function FillBy(ByVal dataTable As StorageDataSet.PostsDataTable, ByVal query As String) As Integer
        ...
        Public Function GetDataBy(ByVal query As String) As StorageDataSet.PostsDataTable
            Dim command As SQLiteCommand = New SQLiteCommand(query, Me.Connection)
    ...
    Partial Public Class IconsTableAdapter
        Public Function FillBy(ByVal dataTable As StorageDataSet.IconsDataTable, ByVal query As String) As Integer
            Dim command As SQLiteCommand = New SQLiteCommand(query, Me.Connection)
            command.CommandType = CommandType.Text
            Me.Adapter.SelectCommand = command
            If Me.ClearBeforeFill Then dataTable.Clear()
        ...
        Public Function GetDataBy(ByVal query As String) As StorageDataSet.IconsDataTable
            Dim command As SQLiteCommand = New SQLiteCommand(query, Me.Connection)
            command.CommandType = Data.CommandType.Text
            Me.Adapter.SelectCommand = command
