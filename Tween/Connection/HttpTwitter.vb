...
Public Class HttpTwitter
    ...
    Private Sub InitializeCount()
        ...
        End If
        RaiseEvent ApiInformationChanged(Me, New ApiInformationChangedEventArgs)
    End Sub
    ...
    Private ReadOnly Property RemainCountApi() As Integer
        Get
    ...
    Private ReadOnly Property UpperCountApi() As Integer
        Get
            Dim result As Integer = 0
    ...
    Private ReadOnly Property ResetTimeApi() As DateTime
        Get
            Dim i As Integer
...
#End Region
    ...
    Private Sub GetApiCallback()
        ApiInformation.MaxCount = UpperCountApi
        ApiInformation.RemainCount = RemainCountApi
        ApiInformation.ResetTime = ResetTimeApi
    End Sub
