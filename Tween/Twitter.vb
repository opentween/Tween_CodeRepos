...
Public Class Twitter
    ...
    Private _splitPost As String = "<tr class=""hentry"" id=""status_"
    Private _splitPostRecent As String = "<tr class=""hentry hentry_hover"" id=""status_"
    Private _statusIdTo As String = """"
    'Private _splitDM As String = "<li><a href=""/direct_messages/destroy/"
    Private _splitDM As String = "<form method=""post"" action=""/direct_messages/destroy/"
    ...
    Private _parseDM1 As String = "</strong>"
    Private _parseDM2 As String = "<span class=""meta"">"
    Private _parseDate As String = "<abbr class=""published"" title="""
    Private _parseDateTo As String = """"
    Private _getAuthKey As String = "<input name=""authenticity_token"" type=""hidden"" value="""
    Private _getAuthKeyTo As String = """"
    Private _parseStar As String = "<img alt=""Icon_star_"
    Private _parseStarTo As String = """"
    Private _parseStarEmpty As String = "empty"
    Private _followerList As String = "<option value="""" selected=""selected""></option>"
    Private _followerMbr1 As String = "<option value="""
    Private _followerMbr2 As String = """>"
    Private _followerMbr3 As String = "</option>"
    'Private _getSiv As String = "<input type=""hidden"" name=""siv"" value="""
    'Private _getSivTo As String = """"
    Private _getInfoTwitter As String = "<div class=""yellow-box"">"
    ...
    Private Function SignIn() As String
        ...
        resMsg = _mySock.GetWebResponce("https://" + _hubServer + _loginPath, resStatus, MySocket.REQ_TYPE.ReqPOST, account)
    ...
    Public Function GetTimeline(ByVal tLine As List(Of MyListItem), ByVal page As Integer, ByVal initial As Boolean, ByRef endPage As Integer, ByVal gType As GetTypes, ByVal imgKeys As Collections.Specialized.StringCollection, ByVal imgs As ImageList) As String
        ...
        If gType = GetTypes.GET_TIMELINE Then
            retMsg = _mySock.GetWebResponce("https://" + _hubServer + _homePath + pageQuery, resStatus)
        Else
            retMsg = _mySock.GetWebResponce("https://" + _hubServer + _replyPath + pageQuery, resStatus)
        End If
                ...
                If links.Contains(lItem.Id) = False Then
                    ...
                    Do While True
                        If orgData.IndexOf("<a href=""http://tinyurl.com/", posl2) > -1 Then
                            ...
                            retUrlStr = _mySock.GetWebResponce(urlStr, responce, MySocket.REQ_TYPE.ReqGETForwardTo)
    ...
    Public Function GetDirectMessage(ByVal tLine As List(Of MyListItem), ByVal page As Integer, ByRef endPage As Integer, ByVal gType As GetTypes, ByVal imgKeys As Collections.Specialized.StringCollection, ByVal imgs As ImageList) As String
        ...
        If gType = GetTypes.GET_DMRCV Then
            retMsg = _mySock.GetWebResponce("https://" + _hubServer + _DMPathRcv + pageQuery, resStatus)
        Else
            retMsg = _mySock.GetWebResponce("https://" + _hubServer + _DMPathSnt + pageQuery, resStatus)
        End If
        If retMsg.Length = 0 Then
            _signed = False
            Return resStatus
    ...
    Private Sub GetIconImage(ByVal pathUrl As String, ByVal imgKeys As Collections.Specialized.StringCollection, ByVal imgs As ImageList)
        ...
        '''img = mySock.GetWebResponce(pathUrl, resStatus, MySocket.REQ_TYPE.ReqGETBinary)
        img = _mySock.GetWebResponce(pathUrl, resStatus, MySocket.REQ_TYPE.ReqGETBinary)
        ...
        ''Dim img2 As Image = mySock.GetWebResponce(pathUrlSmall, resStatus, MySocket.REQ_TYPE.ReqGETBinary)
    ...
    Public Function PostStatus(ByVal postStr As String, ByVal reply_to As Integer) As String
        ...
        'Dim resStatus As String = ""
        'Dim resMsg As String = _mySock.GetWebResponce("https://" + _hubServer + _statusUpdatePath, resStatus, MySocket.REQ_TYPE.ReqPOSTEncodeProtoVer1, dataStr)
    ...
    Public Function RemoveStatus(ByVal id As String) As String
        ...
        Dim resStatus As String = ""
        Dim resMsg As String = _mySock.GetWebResponce("https://" + _hubServer + _StDestroyPath + id, resStatus, MySocket.REQ_TYPE.ReqPOSTEncode, dataStr, "https://" + _baseUrlStr + _homePath)
    ...
    Public Function PostFavAdd(ByVal id As String) As String
        ...
        Dim dataStr As String = _authKeyHeader + HttpUtility.UrlEncode(_authKey)
        Dim resStatus As String = ""
        Dim resMsg As String = _mySock.GetWebResponce("https://" + _hubServer + _postFavAddPath + id, resStatus, MySocket.REQ_TYPE.ReqPOSTEncodeProtoVer2, dataStr)
    ...
    Public Function PostFavRemove(ByVal id As String) As String
        ...
        Dim dataStr As String = _authKeyHeader + HttpUtility.UrlEncode(_authKey)
        Dim resStatus As String = ""
        Dim resMsg As String = _mySock.GetWebResponce("https://" + _hubServer + _postFavRemovePath + id, resStatus, MySocket.REQ_TYPE.ReqPOSTEncodeProtoVer2, dataStr)
    ...
    Public Sub GetWedata()
        ...
        resMsg = _mySock.GetWebResponce(wedataUrl, resStatus)
