...
#End Region
    ...
    Private ThumbnailServices As ThumbnailService() = {
        ...
        New ThumbnailService With {.Name = "ニコニコ動画", .urlCreator = AddressOf nicovideo_GetUrl, .imageCreator = AddressOf nicovideo_CreateImage}
    }
...
#If 0 Then
            ...
            'PhotoShare の短縮 URL 動作未検証　あとで検証する
