...
Partial Class Setting
    ...
    Private Sub InitializeComponent()
        ...
        'Label70
        '
        Me.Label70.AccessibleDescription = Nothing
        Me.Label70.AccessibleName = Nothing
        resources.ApplyResources(Me.Label70, "Label70")
        Me.Label70.Font = Nothing
        Me.Label70.Name = "Label70"
        '
        'CheckStartupAPImodeNoWarning
        '
        Me.CheckStartupAPImodeNoWarning.AccessibleDescription = Nothing
        Me.CheckStartupAPImodeNoWarning.AccessibleName = Nothing
        resources.ApplyResources(Me.CheckStartupAPImodeNoWarning, "CheckStartupAPImodeNoWarning")
        Me.CheckStartupAPImodeNoWarning.BackgroundImage = Nothing
        Me.CheckStartupAPImodeNoWarning.Font = Nothing
        ...
        'Label66
        '
        Me.Label66.AccessibleDescription = Nothing
        Me.Label66.AccessibleName = Nothing
        resources.ApplyResources(Me.Label66, "Label66")
        Me.Label66.Font = Nothing
        Me.Label66.Name = "Label66"
        '
        'CheckPostMethod
        '
        Me.CheckPostMethod.AccessibleDescription = Nothing
        Me.CheckPostMethod.AccessibleName = Nothing
        resources.ApplyResources(Me.CheckPostMethod, "CheckPostMethod")
        Me.CheckPostMethod.BackgroundImage = Nothing
        Me.CheckPostMethod.Font = Nothing
